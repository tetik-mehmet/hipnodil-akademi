...
export default function AdminPage() {
  ...
  const [isVideoStatsOpen, setIsVideoStatsOpen] = React.useState(false);
  ...
  return (
    <main className="min-h-screen w-full bg-gray-50 dark:bg-gray-900">
      <section className="mx-auto max-w-6xl px-4 py-8">
        ...
        {/* Video İstatistikleri Bölümü */}
        <section className="mt-10">
          <div className="pb-4 border-b border-gray-200 dark:border-gray-700 mb-4">
            <button
              onClick={() => setIsVideoStatsOpen(!isVideoStatsOpen)}
              className="flex items-center gap-3 text-xl font-bold text-gray-900 dark:text-gray-100 hover:text-purple-600 dark:hover:text-purple-400 transition-colors group"
            >
              <svg
                className={`w-7 h-7 text-purple-600 dark:text-purple-400 transition-all duration-200 group-hover:scale-110 ${
                  isVideoStatsOpen ? "rotate-90" : ""
                }`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
...
function VideoStatsPanel() {
  ...
  if (loading) {
    return (
      <div className="flex items-center gap-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">İstatistikler yükleniyor…</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Özet Kartlar — sadece Toplam İzlenme + Tamamlayan */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5 shadow-sm">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Toplam İzlenme Süresi</span>
          </div>
        ...
        <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5 shadow-sm">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Tamamlanan Video</span>
          </div>
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">
                ...
                {filteredViewerStats.map((v) => (
                  ...
                  >
                    <td className="px-4 py-3 font-medium text-gray-900 dark:text-gray-100">
                      {v.name || <span className="text-gray-400 italic">İsimsiz</span>}
                    </td>
        ...
        <div>
          ...
          <div className="overflow-x-auto rounded-xl border border-gray-200 dark:border-gray-700">
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-50 dark:bg-gray-800/60 border-b border-gray-200 dark:border-gray-700">
                  <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-400">Kurs</th>
      ...
      {videoStats.length === 0 && (
        <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-8 text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">Henüz video izleme kaydı bulunmuyor.</p>
        </div>
      )}

      {videoStats.length > 0 && filteredVideoStats.length === 0 && viewerFilter && (
        <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            &ldquo;<span className="font-medium text-gray-700 dark:text-gray-300">{viewerFilter}</span>&rdquo; adına ait izleme kaydı bulunamadı.
          </p>
        </div>
      )}
    </div>
